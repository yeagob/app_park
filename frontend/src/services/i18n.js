...
const translations = {
    es: {
        ...
        selectLocation: 'Selecciona la ubicación en el mapa',
        mapHelp: 'Haz clic en el mapa o arrastra el marcador para seleccionar la ubicación del parque',
        noLocationSelected: 'Selecciona una ubicación en el mapa',
    ...
    en: {
        ...
        mapHelp: 'Click on the map or drag the marker to select the park location',
        noLocationSelected: 'Select a location on the map',
